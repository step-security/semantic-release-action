...
### Step2: [Add Secrets](https://help.github.com/en/actions/configuring-and-managing-workflows/creating-and-storing-encrypted-secrets) in your repository for the Semantic Release Authentication Environment Variables.
...
steps:
  ...
  - name: Semantic Release
    uses: step-security/semantic-release-action@v6
    env:
...
If no version range is specified with `step-security/semantic-release-action@v6` then [semantic-release@latest](https://github.com/semantic-release/semantic-release/releases) is used.
...
[release-url]: https://github.com/step-security/semantic-release-action/releases
